...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "file_history.models",
        "file_history.store",
        "file_history.manager",
        "file_history.file_service",
        "file_history.trash_base",
        "file_history.windows_recycle",
        *(["pythoncom", "pywintypes", "win32com.shell.shell", "win32com.server.policy"]
